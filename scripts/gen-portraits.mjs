...
const subjects = [
  ...
  { key:'cartoon_wolf',   prompt:'High-end 3D animated film portrait of an anthropomorphic stylized wolf character, Pixar / DreamWorks quality, soft white-grey fur, large expressive forward-facing eyes with crisp highlights, friendly proportions, simple casual hoodie, cel-shaded look, painted snowy pine forest backdrop with golden-hour bokeh, cinematic key frame' },
  { key:'cartoon_fox',    prompt:'High-end 3D animated film portrait of an anthropomorphic stylized red fox character, Pixar / DreamWorks quality, vibrant orange-red fur with white belly, large expressive forward-facing eyes with crisp highlights, friendly proportions, simple casual outfit, cel-shaded look, painted autumn forest backdrop with warm bokeh, cinematic key frame' },
  { key:'cartoon_bear',   prompt:'High-end 3D animated film portrait of an anthropomorphic stylized brown bear character, Pixar / DreamWorks quality, soft brown fur, large expressive forward-facing eyes with crisp highlights, friendly proportions, simple casual vest, cel-shaded look, painted mountain meadow backdrop at sunset, cinematic key frame' },
  { key:'cartoon_owl',    prompt:'High-end 3D animated film portrait of an anthropomorphic stylized owl character with a flat round face, Pixar / DreamWorks quality, mottled brown-grey feathers, huge round forward-facing eyes with crisp highlights, friendly proportions, simple casual sweater, cel-shaded look, painted old library backdrop at dusk with warm lamp glow, cinematic key frame' },
  { key:'cartoon_tiger',  prompt:'High-end 3D animated film portrait of an anthropomorphic stylized tiger character, Pixar / DreamWorks quality, vivid orange fur with bold black stripes, large expressive forward-facing eyes with crisp highlights, friendly proportions, simple casual outfit, cel-shaded look, painted lush jungle clearing backdrop with warm light shafts, cinematic key frame' },
  { key:'cartoon_monkey', prompt:'High-end 3D animated film portrait of an anthropomorphic stylized macaque character, Pixar / DreamWorks quality, flesh-pink face surrounded by warm brown fur, large expressive forward-facing eyes with crisp highlights, friendly human-readable proportions, simple casual outfit, cel-shaded look, painted tropical jungle canopy backdrop with golden light shafts, cinematic key frame' },
];
